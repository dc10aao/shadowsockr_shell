...
#   Author: liao06550107 <liao06550107@gmail.com>                 #
...
pre_install(){
    ...
    read -p "(Default password: diaomao.com):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="diaomao.com"
    echo
    echo "---------------------------"
...
install(){
    ...
    if [ -f /usr/local/shadowsocks/server.py ]; then
        ...
        echo "ShadowsocksR install failed, please Email to liao06550107 <liao06550107@gmail.com> and contact"
        install_cleanup
        exit 1
    fi
}
